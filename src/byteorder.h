...
static inline uint32_t ksuid_be32_load(const uint8_t *p) {
...
static inline void ksuid_be32_store(uint8_t *p, uint32_t v) {
    p[0] = (uint8_t)(v >> 24);
    p[1] = (uint8_t)(v >> 16);
    p[2] = (uint8_t)(v >>  8);
    p[3] = (uint8_t)(v      );
...
static inline uint64_t ksuid_be64_load(const uint8_t *p) {
...
static inline void ksuid_be64_store(uint8_t *p, uint64_t v) {
    p[0] = (uint8_t)(v >> 56);
    p[1] = (uint8_t)(v >> 48);
    p[2] = (uint8_t)(v >> 40);
    p[3] = (uint8_t)(v >> 32);
